...
5. requirement.txt
    ...
    d.langchain - Its a framework. This of it like a jdbc, jdbc connects java to the database. similarly Langchain connects python to ollama. helps to connect LLM to application and tools/Data/API
...
What exactly happens when an LLM calls a tool?
 ...
 2. But I can't actually, open your csv, count null values, calculate duplicates rows, query your database.
...
2. Then agent needs to rememeber file path, schema, quality, final report.
